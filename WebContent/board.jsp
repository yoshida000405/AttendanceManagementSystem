						...
						<div class="card">
							...
							<div class="form-group row text-center">
								<div class="col-md-12 text-center">
									<h5 id="subject1B"></h5>
									<input id="subjectB" type="text" size="52" >
								</div>
							</div>
							</div>
							...
							<div class="card-body">
								<div class="form-group row text-center" id="append">
									...
									<div class="col-md-12 text-center">
										<textarea id="content" cols="70" rows="20"></textarea>
									</div>
								</div>
								<div id="editDiv" class="text-right mt-5">
									<button type="submit" class="btn btn-primary ml-3" id="update">更新</button>
									<button type="submit" class="btn btn-primary ml-3" id="edit">編集</button>
								</div>
							</div>
						</div>
