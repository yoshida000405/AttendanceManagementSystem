					...
					<div class="col-md-10">
						<div class="card">
							<div class="card-header border">
								<div class="col-md-6 float-left">新規ユーザー登録</div>
							...
							<div class="card-body">
								<div class="mt-4">
									<form id="form2" method="post">
										...
										<div class="clearfix mt-5">
											<label for="password"
												class="col-md-4 col-form-label float-left text-md-center">新しいパスワード</label>
											<input id="password" type="password"
												class="col-md-7 form-control float-left" name="password"
												value="password" required>
										</div>
										<div class="clearfix mt-5">
											<label for="passwordConfirm"
												class="col-md-4 col-form-label float-left text-md-center">新しいパスワード(確認用)</label>
											<input id="passwordConfirm" type="password"
												class="col-md-7 form-control float-left"
												name="passwordConfirm" value="password" required>
										</div>
										<div class="clearfix mt-5">
											<label for="gender"
										...
										<div class="clearfix mt-5">
											<label for="pto"
												class="col-md-4 col-form-label float-left text-md-center">残有給数</label>
											<input id="pto" type="text"
												class="col-md-7 form-control float-left" name="pto"
												required>
										</div>
									</form>
