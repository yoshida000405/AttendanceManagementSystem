					...
					<div class="col-md-8">
						<div class="card">
							<div class="card-header border">
								<div class="col-md-12 text-center"><h5>投稿一覧</h5></div>
							</div>

							<div class="card-body" id="append">

							</div>
						</div>
						<div class="mt-4">
							<div class="col-4 text-left float-left"><h5 id="forward">前へ</h5></div>
							<div class="col-4 text-center float-left"></div>
...
<script type="text/javascript" src="common/JS/boardAll.js"></script>
</html>
<%
	}
%>